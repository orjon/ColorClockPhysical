char CodeFilename[] = "ColourClock YUN";
...
//YUN
#define DATA_PIN    MOSI // MOSI Yun
#define CLOCK_PIN   SCK // SCK Yun

//NANO
//#define DATA_PIN    11 //MOSI Nano
//#define CLOCK_PIN   13 //SCK Nano
...
//NANO  
//  attachInterrupt(0, ButtonA, LOW);  //Interrupt 0 = Pin2 NANO
//  attachInterrupt(1, ButtonB, LOW);  //Interrupt 1 = Pin3 NANO
//YUN 
  attachInterrupt(0, ButtonA, LOW);  //Interrupt 0 = Pin2 YUN
  attachInterrupt(1, ButtonB, LOW);  //Interrupt 1 = Pin3 YUN
